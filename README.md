...
*Source files live in the repo as [`reports/IK_results.gif`](results/IK.gif) (update by copying from e.g. `Downloads/IK results.gif` if you re-record).
...
![Inverse dynamics — ankle & knee moments vs time](results/ID.gif)
